...
ActiveRecord::Schema.define(version: 20170116005550) do
  ...
  create_table "manifestation_checkout_stats", force: :cascade do |t|
    ...
    t.index ["state"], name: "index_manifestation_checkout_stats_on_state"
  end
  ...
  create_table "manifestation_reserve_stats", force: :cascade do |t|
    ...
    t.datetime "started_at"
    t.datetime "completed_at"
    t.index ["state"], name: "index_manifestation_reserve_stats_on_state"
  end
  ...
  create_table "reserves", force: :cascade do |t|
    ...
    t.index ["state"], name: "index_reserves_on_state"
  ...
  create_table "user_checkout_stats", force: :cascade do |t|
    ...
    t.datetime "started_at"
    t.datetime "completed_at"
    t.index ["state"], name: "index_user_checkout_stats_on_state"
  end
  ...
  create_table "user_reserve_stats", force: :cascade do |t|
    ...
    t.datetime "started_at"
    t.datetime "completed_at"
    t.index ["state"], name: "index_user_reserve_stats_on_state"
  end
